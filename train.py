...
if __name__ == '__main__':
    ...
    train_data_loader = create_data_loader(train_opt)
    ...
    valid_data_loader = create_data_loader(valid_opt)
    ...
    tfcount = 0
    F_score_max = 0
    for epoch in range(train_opt.starting_epoch, train_opt.epoch_count + 1):
        model.train()
        ...
        if train_opt.use_surface_normal:
