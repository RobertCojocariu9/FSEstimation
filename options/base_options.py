...
class BaseOptions:
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', required=True, help='path to images, should have training, validation and '
                                                              'testing')
        ...
        parser.add_argument('--use_surface_normal', action='store_true', help='chooses if using surface normal')
        parser.add_argument('--dataset', type=str, default='kitti', help='chooses which dataset to load.')
        parser.add_argument('--model', type=str, default='fsnet', help='chooses which model to use.')
